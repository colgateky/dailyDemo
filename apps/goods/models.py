...
class Goods(BaseModel):
    ...
    spu_top_banner = models.ImageField(upload_to='goods', verbose_name='商品TopBanner图片', default='')
    spu_banner01 = models.ImageField(upload_to='goods', verbose_name='商品Banner图片', default='')
    spu_banner02 = models.ImageField(upload_to='goods', verbose_name='商品Banner图片', default='')
    spu_banner03 = models.ImageField(upload_to='goods', verbose_name='商品Banner图片', default='')
